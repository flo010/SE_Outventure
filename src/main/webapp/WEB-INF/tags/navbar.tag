...
<nav class="navbar bg-dark navbar-expand-lg bg-body-tertiary" data-bs-theme="dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="../../hike/index/index.jsp" onclick="clearSearchString()">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <form id="search-input" action="../../search_results" method="get" class="form-inline form-search mx-auto">
                    <div class="input-group">
                        <button class="btn btn-outline-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false" style=" color:white; width:80px">
                            <span id="selectedItem"><%=selectedSearchItem%></span>
                        </button>
            ...
            <div class="navbar-nav ml-auto">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a class="nav-link" href="../../user_management/profile/profile.jsp">
                                Profile
                            </a>
                        </li>
                        <li>
                            <a class="nav-link" href="../../hike/create_hike/create_hike.jsp">Create Hike</a>
                        </li>
                        <li>
                    ...
                    <% } else { %>
                    <a class="nav-link" href="../../user_management/login/login.jsp">Login</a>
                    <% } %>
                </div>
            </div>
        </div>
