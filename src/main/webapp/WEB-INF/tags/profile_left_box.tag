...
<div class="left-box">
    <ul>
        <hr>
        <li>
            <a href="/user_management/profile/profile.jsp" class="active">
        ...
        <hr>
        <li>
            <a href="/profile_hike_list" class="active">
        ...
        <hr>
        <li>
            <a href="/completed_hike" class="active">
        ...
        <hr>
        <li>
            <a href="/favorite_hike?hikeID=-1&hikerID=<%=session.getAttribute("hikerID")%>&page=left-box" class="active">
        ...
        <hr>
        <li>
            <a href="/user_management/performance_statistics/performance_statistics.jsp" class="active">
