        ...
        <div class="container-sm mt-5 mb-5">
            ...
            <div class="tab-content mt-4" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-overview" role="tabpanel" aria-labelledby="pills-overview-tab" tabindex="0">
                    ...
                    <div class="mt-5">
                        <button type="button" id="exportButton" class="btn btn-outline-secondary" onclick="exportGPX()">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-upside-down" viewBox="0 0 16 16" style="vertical-align: text-top;">
                                <path fill-rule="evenodd" d="M8 1.5a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 1 1 .708-.708L7.5 13.293V2a.5.5 0 0 1 .5-.5z"></path>
                            </svg>
                            Export GPX
                        </button>
                    </div>
